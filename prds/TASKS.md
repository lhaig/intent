...
| 48i | method-call arity + arg-types | — | TODO | Needs the receiver's entity type → `self` typed as the entity + field-access inference (self.field → field type). Larger — the next big inference unlock |
