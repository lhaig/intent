...
| 42.6 | Gap: `forall`/`exists` quantifier expressions | [phase-42-formatter-cli-differential.md](active/phase-42-formatter-cli-differential.md) | DONE (2026-06-16) | ex_forall/ex_exists primaries; `in` as ident; sorted_check PASS; 19/22 |
| 42.7 | Gap: `implies` operator | [phase-42-formatter-cli-differential.md](active/phase-42-formatter-cli-differential.md) | DONE (2026-06-16) | folded into parse_assign (no new parse-chain frame); try_operator PASS |
