...
| 43.9 | Type-param position enrichment + R15 (fn) + R15e (entity) | [prd-phase-43-self-hosted-linter.md](active/prd-phase-43-self-hosted-linter.md) | TODO | additive parallel type_param_lines/columns in ast+parser (formatter untouched); token-aware usage check; byte-equal; needs: 43.5,43.6 |
