...
| 43.8 | AST enrichment + R3, R4, R15, R15e | [prd-phase-43-self-hosted-linter.md](active/prd-phase-43-self-hosted-linter.md) | TODO | parse+store TraitMethodSig & ExternDecl requires/ensures; FunctionDecl/EntityDecl type-param positions; then byte-equal R3/R4/R15/R15e; needs: 43.5,43.6,43.7 |
